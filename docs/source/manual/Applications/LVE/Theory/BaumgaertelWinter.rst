...
.. automodule:: RepTate.theories.TheoryBaumgaertelWinter.TheoryBaumgaertelWinter

Description
-----------

Fit of linear viscoelastic data with generalized Maxwell spectrum using the 
Baumgaertel-Winter method to adjust the number of modes. The relaxation modulus is written as:

.. math::
    G'(\omega) &= G_e + \sum_i G_i
