...
def test_LVE_Likhtman_McLeish():
    ...
    assert tau_e == pytest.approx(0.06773845511821698, rel=1e-6)
    assert Ge == pytest.approx(509664.8088612225, rel=1e-6)
    assert Me == pytest.approx(4.492962262350123, rel=1e-6)
...
def test_LVE_Maxwell_Modes():
    ...
    assert logwmin == pytest.approx(-6.385241978597786, rel=1e-6)
    assert logwmax == pytest.approx(3.0010913446595318, rel=1e-6)
    assert nmodes == 9
    assert logG00 == pytest.approx(-9.98121345866038, rel=1e-6)
    assert logG01 == pytest.approx(2.6532429979420713, rel=1e-6)
    assert logG02 == pytest.approx(5.219297965636228, rel=1e-6) 
    assert logG03 == pytest.approx(5.0406510877327815, rel=1e-6)
    assert logG04 == pytest.approx(4.804722071852002, rel=1e-6)
    assert logG05 == pytest.approx(4.687069287243573, rel=1e-6)
    assert logG06 == pytest.approx(5.145666298139436, rel=1e-6)
    assert logG07 == pytest.approx(5.76694930919948, rel=1e-6)
    assert logG08 == pytest.approx(6.829225757858246, rel=1e-6) 
...
def test_LVE_DTD_Stars():
    ...
    assert G0 == pytest.approx(0.8513160549985747, rel=1e-6)
    assert tau_e == pytest.approx(5.417382973435641e-06, rel=1e-6)
    assert Me == pytest.approx(4.369223232374666, rel=1e-6) 
    assert alpha == 1.0
