...
a = Analysis(['RepTate.py'],
             ...
             binaries=[('theories/kww_lib_darwin.so', '.'), ('theories/rouse_lib_darwin.so', '.'), ('theories/bob2p5_lib_darwin.so', '.'), ('theories/rp_blend_lib_darwin.so', '.'), ('theories/dtd_lib_darwin.so', '.'), ('theories/schwarzl_lib_darwin.so', '.'), ('theories/react_lib_darwin.so', '.'),  ('theories/sccr_lib_darwin.so', '.')],
