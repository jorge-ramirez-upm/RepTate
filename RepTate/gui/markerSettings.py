...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_6.addWidget(self.cbTheoryLine)
        ...
        self.horizontalLayout_6.addWidget(self.sbThLineWidth)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_7.setTitle(_translate("Dialog", "Theory"))
        self.groupBox_8.setTitle(_translate("Dialog", "Type"))
