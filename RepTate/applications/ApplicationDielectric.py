...
class ApplicationDielectric(QApplicationWindow):
    ...
    def __init__(self, name: str = "Dielectric", parent: ApplicationManagerLike | None = None) -> None:
        ...
        self.views["e',e''(w)"] = View(
            name = "e',e''(w)",
            description = "Relative permittivity, Dielectric Loss",
            x_label=r"$\omega$",
            y_label=r"$\epsilon',\epsilon''$",
            x_units="rad/s",
            y_units="-",
        ...
        self.views["e''"] = View(
            ...
            log_x=True,
            log_y=True,
            view_proc=self.viewE2,
            n=1,
            snames=["e''"],
        )
        self.views["Cole-Cole"] = View(
            name="Cole-Cole",
            description="Cole-Cole plot",
            x_label=r"$\epsilon'$",
            y_label=r"$\epsilon''$",
            x_units="-",
            y_units="-",
