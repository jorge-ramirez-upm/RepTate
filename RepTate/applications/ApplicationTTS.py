...
class ApplicationTTS(QApplicationWindow):
    ...
    appname: ClassVar[str] = "TTS"
    description: ClassVar[str] = "Linear Viscoelasticity"
    extension: ClassVar[str] = "osc"
    html_help_file: ClassVar[str] = "http://reptate.readthedocs.io/manual/Applications/TTS/TTS.html"

    def __init__(self, name: str = "TTS", parent: ApplicationManagerLike | None = None) -> None:
        """**Constructor**"""
