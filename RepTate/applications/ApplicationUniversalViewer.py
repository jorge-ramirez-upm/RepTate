...
class ApplicationUniversalViewer(CmdBase):
    ...
    def __new__(cls, name='Universal Viewer', parent=None, inifile=None, nplot_max=1):
        """Generic Constructor for CL and GUI"""
        return GUIApplicationUniversalViewer(name, parent, inifile, nplot_max) if (
            CmdBase.mode == CmdMode.GUI) else CLApplicationUniversalViewer(
                name, parent, inifile, nplot_max)


class BaseApplicationUniversalViewer:
    """Common class for GUI and CL"""
