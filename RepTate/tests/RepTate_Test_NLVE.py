...
def start_RepTate(argv):
    ...
    pi_dir = "data%sDOW%sNon-Linear_Rheology%sStart-up_Shear%s"%((os.sep,)*4)
    ex.applications["NLVE1"].new_tables_from_files([
                                                   pi_dir + "My_dow150-160-1 shear.shear",
                                                   pi_dir + "My_dow150-160-01 shear.shear",
                                                   pi_dir + "My_dow150-160-001 shear.shear",
                                                   pi_dir + "My_dow150-160-3 shear.shear",
                                                   pi_dir + "My_dow150-160-03 shear.shear",
                                                   pi_dir + "My_dow150-160-003 shear.shear",
                                                   pi_dir + "My_dow150-160-0003 shear.shear",
                                                   ])
    # Open a theory
