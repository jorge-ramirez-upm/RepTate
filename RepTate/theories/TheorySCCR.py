...
class BaseTheorySCCR:
    ...
    def SCCR(self, f=None):
        ...
        try:
            sig = odeint(self.pde_shear, self.yeq, t, args=(p, ), full_output = 1, h0=1, rtol=self.relerr)
        ...
        for i in range(1, len(t)):
            ...
            stressTube = np.trapz(Fint,Sint)*3.0/self.N
            ...
            tt.data[i-1,1]=(stressTube*4.0/5.0+stressRouse)*Ge
