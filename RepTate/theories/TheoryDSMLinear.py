...
class TheoryDSMLinear(CmdBase):
    ...
    * **Parameters**"""
    ...
    citations = "Katzarova, M., Yang, L., Andreev, M., Córdoba, A., & Schieber, J. D., Rheologica Acta 2015, 54(3), 169-183."
...
class BaseTheoryDSMLinear:
    ...
    def set_DSM_params(self,Mc,Nc,tau_c,beta,N_K,tau_K):
        ...
        self.parameters["N_K"] = Parameter(
            name=r'N_K',
            value=N_K,
            description="Number of Kuhn steps for input into DSM simulation",
            type=ParameterType.real,
            opt_type=OptType.const,
            display_flag=True)
    ...
    def calculate(self, f=None):
        ...
        MK = float(f.file_parameters["MK"]) #units of Da
        rho0 = float(f.file_parameters["rho0"]) #units of g/cc
