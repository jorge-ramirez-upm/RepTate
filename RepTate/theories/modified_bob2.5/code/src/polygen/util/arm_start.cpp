...
if((arm_pool[n].L1==-1 && arm_pool[n].L2==-1) ||
 ...
 { // one end of n is free
  arm_pool[n].free_end=true; arm_pool[n].relaxing=true;
  arm_pool[n].relax_end=n; arm_pool[n].compound=false;
  arm_pool[n].z=0.0; arm_pool[n].pot=0.0;
  arm_pool[n].gamma2 = sqrt(1.50*(pi_pow_5)* 
         (pow(arm_pool[n].arm_len,(double)3))/phi);
  arm_pool[n].tau_K=0.0; arm_pool[n].dz=0.0;
  arm_pool[n].arm_len_eff=arm_pool[n].arm_len; 
  arm_pool[n].arm_len_end=arm_pool[n].arm_len;
  arm_pool[n].deltazeff=0.0; arm_pool[n].zeff_numer=0.0; 
  arm_pool[n].zeff_denom=0.0; arm_pool[n].extra_drag=0.0;
 ...
 { //both ends are connected
  arm_pool[n].free_end=false; arm_pool[n].relaxing=false;
