...
arm_pool[n1].up=n2;arm_pool[n1].down=n3;
arm_pool[n2].up=n3;arm_pool[n2].down=n1;
arm_pool[n3].up=n1;arm_pool[n3].down=n2;
...
int nd=arm_pool[n0].down; arm_pool[n0].down=n1; arm_pool[n1].up=n0;
arm_pool[n1].down=n2; arm_pool[n2].up=n1; arm_pool[n2].down=nd;
arm_pool[nd].up=n2;

if(arm_pool[n0].L1 == -1){
arm_pool[n0].L1=n1; arm_pool[n0].L2=n2;
attach_arm(n1,-1,-1,n0,n2);
attach_arm(n2,-1,-1,n0,n1);
                         }
else{
arm_pool[n0].R1=n1; arm_pool[n0].R2=n2;
