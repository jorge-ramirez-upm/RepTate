...
int ret_val =0;
int r2=arm_pool[n2].relax_end; int r1=arm_pool[n1].relax_end;
double t_a=0.0; double t_b=0.0; double t_c=0.0; double tt;
...
while(k1 != -1){
  ...
  t_a += tt; t_b += tt * zouter;
  zouter+=arm_pool[k2].arm_len;
  k2=arm_pool[k2].nxt_relax; k1=arm_pool[k1].next_friction;
               }
  tt = arm_pool[r1].tau_collapse*pow(arm_pool[r1].phi_collapse,2.0*Alpha);
  t_a += tt; t_b += tt * zouter;

zouter=arm_pool[r2].arm_len;
k1=arm_pool[r2].next_friction; k2=arm_pool[r2].nxt_relax;
while(k1 != -1){
  tt   = arm_pool[k1].tau_collapse*pow(arm_pool[k1].phi_collapse,2.0*Alpha);
  t_a -= tt; t_c+= tt*zouter;
  zouter+=arm_pool[k2].arm_len;
  k2=arm_pool[k2].nxt_relax; k1=arm_pool[k1].next_friction;
               }
...
if((xx < arm_pool[n2].arm_len) && 
  ...
  {
    int na=request_arm(); int n0=inner_arm_compound(n);
    if((arm_pool[n2].L1 == n0) || (arm_pool[n2].L2 == n0))
     {
      arm_pool[n2].L1= na; arm_pool[n2].L2=-1; 
      arm_pool[na].R1= n2; arm_pool[na].R2=-1;
      arm_pool[na].L1=n0; arm_pool[na].L2=n1;
       if(arm_pool[n0].R1 == n2) {arm_pool[n0].R1 = na;}
       else {arm_pool[n0].R2 = na;}
       if(arm_pool[n1].R1 == n2) {arm_pool[n1].R1 = na;}
       else {arm_pool[n1].R2 = na;}
     }
    else
     {
      arm_pool[n2].R1= na; arm_pool[n2].R2=-1; 
      arm_pool[na].L1= n2; arm_pool[na].L2=-1;
      arm_pool[na].R1=n0; arm_pool[na].R2=n1;
       if(arm_pool[n0].L1 == n2) {arm_pool[n0].L1 = na;}
       else {arm_pool[n0].L2 = na;}
       if(arm_pool[n1].L1 == n2) {arm_pool[n1].L1 = na;}
       else {arm_pool[n1].L2 = na;}
     }
   ...
   arm_pool[n].nxtbranch1=na; arm_pool[n].nxtbranch2=-1;
   arm_pool[n2].arm_len-=xx;
   arm_pool[r2].arm_len_end -= xx;
   int nd=arm_pool[n2].down; arm_pool[n2].down=na;
   arm_pool[na].up=n2; arm_pool[na].down=nd; arm_pool[nd].up=na;
   arm_pool[r2].nxtbranch1=na; arm_pool[r2].nxtbranch2=-1;
   arm_pool[na].nxt_relax=-1; arm_pool[na].prune=false;
   arm_pool[na].ghost=false; arm_pool[na].collapsed=false;
