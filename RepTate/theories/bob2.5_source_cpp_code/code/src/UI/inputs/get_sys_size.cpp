...
printf("Maximum number of arms ? ... "); scanf("%d", &max_arm); }
else {max_arm=2*max_poly;} }
...
if(branched_poly == NULL) {printf("Error : Could not allocate polymers. \n");
abort();}

extern void pool_init(void); pool_init();
