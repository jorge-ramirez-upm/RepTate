    ...
    def __init__(self, name='', parent_dataset=None, ax=None):
        ...
        **Constructor**
        ...
        self.parameters['kDLCB'] = Parameter(
            name='kDLCB',
            value=45,
            description='Rate of long chain branching',
            type=ParameterType.real,
            opt_type=OptType.const)
        ...
        self.parameters['kd'] = Parameter(
            name='kd',
            value=1e-4,
            description='Rate of catalyst deactivation',
            type=ParameterType.real,
            opt_type=OptType.const)
        self.parameters['kt'] = Parameter(
            name='kt',
            value=0.085,
            description='Rate of terminaison',
            type=ParameterType.real,
            opt_type=OptType.const)
        self.parameters['D0'] = Parameter(
            name='D0',
            value=1e-3,
            description='Rate of diene feed',
            type=ParameterType.real,
            opt_type=OptType.const)
        self.parameters['C0'] = Parameter(
            name='C0',
            value=1e-2,
            description='Rate of catalyst feed',
            type=ParameterType.real,
            opt_type=OptType.const)
    ...
    def Calc(self, f=None):
        ...
        while i < numtomake:
            ...
            if success:  # check availability of polymers
                ...
                # make a polymer
                if rch.dieneCSTR(ct.c_int(m), ct.c_int(
