...
class TheoryDieneCSTR(QTheory):
    ...
    def Calc(self, f: FileLike) -> Any:
        ...
        # get parameters
        col_time = self.parameter_float("col_time")
        tau = self.parameter_float("tau")
        kpM = self.parameter_float("kpM")
        kDLCB = self.parameter_float("kDLCB")
        kpLCB = self.parameter_float("kpLCB")
        kpD = self.parameter_float("kpD")
        keq = self.parameter_float("k=")
        ks = self.parameter_float("ks")
        D0 = self.parameter_float("D0")
        C0 = self.parameter_float("C0")
