...
void molbin(int n)
{
    ...
    react_dist[n].nummwdbins = MIN(react_dist[n].nummwdbins, maxmwdbins);
...
void multimolbin(int reqbins, double *weights, bool *inmix)
{
    ...
    multi_nummwdbins = MIN(reqbins, maxmwdbins);
...
void bobinit(int n)
{
    ...
    multi_wt = (double *)malloc(sizeof(double) * (maxmwdbins + 1));
    multi_avbr = (double *)malloc(sizeof(double) * (maxmwdbins + 1));
    multi_wmass = (double *)malloc(sizeof(double) * (maxmwdbins + 1));
    multi_avg = (double *)malloc(sizeof(double) * (maxmwdbins + 1));
    multi_lgmid = (double *)malloc(sizeof(double) * (maxmwdbins + 1));
}
