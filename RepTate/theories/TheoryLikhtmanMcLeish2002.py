...
Macromolecules 2002, 35, 6332-6343"
    ...
    def __init__(self, name="ThLikhtmanMcLeish2002", parent_dataset=None, ax=None):
        ...
        self.parameters["Me"]=Parameter("Me", 5, "Entanglement molecular weight", ParameterType.real, False)
    ...
    def LikhtmanMcLeish2002(self, f=None):
        ...
        for i in range(len(table)):
            tt.data[i,0]=table[i][0]/taue
            tt.data[i,1]=Ge*table[i][ind1]
            tt.data[i,2]=Ge*table[i][ind2]
