...
typedef struct
{
    ...
    int * numin_num_br_bin; // array[1..maxbobbins] branch point statistics statistics
    int num_armwt_bin;
    int max_num_br;
    ...
    bool polysaved;
    char *name;
    double wlin, wstar, wH, w7arm, wcomb, wother;
    int nlin, nstar, nH, n7arm, ncomb, nother, nsaved_arch;
